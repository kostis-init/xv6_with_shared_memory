...
int             get_page(sh_key_t);
int		remove_page(sh_key_t);
int             num_procs_own_page(uint,char);
int             shmem_update_fork(struct proc* np, struct proc* cp);
...
void		unmap_addr(pde_t *pgdir, const void *va);
